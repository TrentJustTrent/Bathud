    ...
    children: [
        {
            ...
            type: 'number',
            default: 8,
            description: 'Corner radius (px) for bars (or frame).',
            reactive: true,
        },
        {
            name: 'borderWidth',
            type: 'number',
            default: 2,
            description: 'Bar (or frame) border width (px).',
            reactive: true,
        },
        {
            name: 'borderColor',
            ...
            description: 'Color of the bar (or frame) border',
            reactive: true,
        },
        {
            ...
            description: 'Color of the bar (or frame) background',
            reactive: true,
        },
        {
            name: 'frameThickness',
